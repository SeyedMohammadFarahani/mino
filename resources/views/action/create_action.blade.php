...
@section('content')
    <h3 class="d-flex justify-content-sm-center" style="margin: 20px">اضافه کردن فرآیند محصول جدید</h3>
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-7">

                <form id="create_user_form" method="post" action="{{route('actions.save')}}"
