...
@section('content')
    <h3 class="d-flex justify-content-sm-center" style="margin: 20px">ویرایش اطلاعات ماده خام</h3>
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-7">

                <form id="create_user_form" method="post"
                      action="{{ route('materials.update', ['id' => $material->id])}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" dir="rtl" step=".0001"
                                       ...
                                       name="price"
                                       value="{{ $material->price }}" autofocus>
                                @error('price')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
