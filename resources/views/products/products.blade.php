...
<head>
    ...
    <title>محصولات (تایید نشده)</title>
                        ...
                        <tr id="tr_{{$product->id}}">
                            ...
                            <td>
                                <a class="btn btn-info"
                                   href="{{ route('products.confirm', ['id' => $product->id])}}">تایید</a>
                            </td>
                            <td>
                            ...
                            <td>
                                <a class="btn btn-danger"
                                   href="{{ route('products.destroy', ['id' => $product->id])}}">حذف</a>
                            </td>
                        </tr>
                        <?php $i++;?>
                    @endforeach
